...
public class BuyTwoGetOneFreeTest {
    ...
    public void noDiscountOnEmptyBasket(){
        ...
        Rebate rebate = buyTwoGetOneFree(Item.Apple);
    ...
    public void noDiscountAppliedOnceForBasketWithoutEligibleItems(){
        Basket b = mock(Basket.class);
        when(b.getItems()).thenReturn(newArrayList(Item.Apple, Item.Orange));
        Rebate rebate = buyTwoGetOneFree(Item.Apple);
    ...
    public void discountAppliedForBasketWithMultipleItems(){
        Basket b = mock(Basket.class);
        when(b.getItems()).thenReturn(newArrayList(Item.Apple, Item.Orange, Item.Apple, Item.Apple));
        Rebate rebate = buyTwoGetOneFree(Item.Apple);
